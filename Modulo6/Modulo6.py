...
def index():
    ...
    return render_template("index_m6.html", palabras=obtenerP)
...
def agregar():
    if request.method == 'POST':
        ...
        if existe(palabra) == True:
            return render_template("agregar_m6.html", message=False)
        else:
            agregar_palabra(palabra.upper(), significado)
            return render_template("agregar_m6.html", message=True)

    return render_template("agregar_m6.html")
...
def editar():
    if request.method == 'POST':
        ...
        if existe(palabra):
            ...
            return render_template("editar_m6.html", message=False)
        else:

            return render_template("editar_m6.html", message=True)
    return render_template("editar_m6.html")
...
def editar_sig():
    if request.method == 'POST':
        ...
        if existe(palabra):
            ...
            return render_template("editar_significado_m6.html", message=False)
        else:
            return render_template("editar_significado_m6.html", message=True)
...
def eliminar():
    if request.method == 'POST':
        ...
        if existe(palabra):
            ...
            obtener_palabras()
            return render_template("eliminar_m6.html", message=False)
        else:
            obtener_palabras()
            return render_template("eliminar_m6.html", message=True)
    return render_template("eliminar_m6.html")
...
def significado():
    if request.method == 'POST':
        ...
        if existe(palabra):
            ...
            return render_template("significado_m6.html", message=False, significado=dato)
        else:
            return render_template("significado_m6.html", message=True)
    return render_template("significado_m6.html")
